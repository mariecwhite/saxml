  ...
  with open(
    ...
    for line in f:
      ...
      if (
          not package_name
          or package_name[0] == '#'
          or package_name.startswith('--find-links')
...
setup(
    ...
    version='1.2.0',
    description=(
        'An experimental system that serves Paxml, JAX, and PyTorch models for inference.'
    ),
    author='SAXML team',
    author_email='saxml-dev@google.com',
